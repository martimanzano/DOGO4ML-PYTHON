...
file_dataset = 'demos/new_pullreq-red.csv'
...
# TRUST STUFF
trustpr = TrustComputationService()
trustpr.readTrustDefinition(configPath=path_configuration)
print(trustpr.computeTrust(trainedModel=rf_classifier, dataX=X_test, dataY=Y_test))

print(trustpr.getTrustAssessmentAsFormattedString())
print("\n")
# print(trustBank.getTrustAssessment())
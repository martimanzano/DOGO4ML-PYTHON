...
class RecallSKL(Metric):
    """Recall score for sklearn-based classifiers using sklearn. The recall is the ratio tp / (tp + fn) where tp is the number of true positives and fn the number of false negatives. The recall is intuitively the ability of the classifier to find all the positive samples.
    ...
    def assess(self, trainedModel, dataX, dataY):
        ...
        self.assessment = recall_score(dataY, pred, average=self.multiclass_average)
...
class WeightedAverage(AssessmentMethod):
    ...
    and hierarchy specified in the configuration file (passed in the additionalProperties constructor's
    parameter).
    ...
    def __init__(self, additionalProperties):
        """Retrieves the dict containing the hierarchical tree to use from the additionalProperties 
    ...
    def assess(self):
        ...
        assessmentAsJSON = exporter.export(trust_hiearchy_node)

        return assessmentAsJSON
    ...
    def evaluate_tree(self, dict_node, hiearchy_parent_node):
        ...
        for node in dict_node:
            ...
            if type(dict_node[node]) is dict:
                ...
                hiearchy_child_node.weight = node_weight
                node_raw_score = self.TWI.getMetricsAssessmentDict()[node]
